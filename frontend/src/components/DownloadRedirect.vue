        ...
        <div>
            <div class="card p-4 shadow-sm">
                ...
                <div class="mb-3">
                    ...
                    <input id="redirects" type="number" class="form-control" v-model.number="redirectCount" min="0"
                        max="5" placeholder="e.g., 2" />
                </div>
                ...
                <button class="btn btn-primary w-100 mb-2" :disabled="!isValidInput || isLoading"
                ...
                <button class="btn btn-secondary w-100" :disabled="!isValidInput || isLoading"
