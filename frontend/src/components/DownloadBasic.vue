        ...
        <div>
            <div class="card p-4 shadow-sm">
                ...
                <div class="mb-3">
                    ...
                    <input id="fileSize" type="number" class="form-control" v-model.number="fileSize"
                        placeholder="e.g., 100" min="1" aria-describedby="sizeHelp" />
                    <div id="sizeHelp" class="form-text">
                ...
                <div class="form-check mb-2">
                    ...
                    <label class="form-check-label" for="enableAbort">
                        Abort Download?
                    </label>
                </div>
                ...
                <div class="mb-3" v-if="enableAbort">
                    ...
                    <input id="abortAfter" type="number" class="form-control" v-model.number="abortAfter"
                        placeholder="e.g., 10" min="1" aria-describedby="abortAfterHelp" />
                    <div id="abortsizeHelp" class="form-text">
                        Server will abort download after this size
                    </div>
                </div>
                ...
                <button @click="downloadUsingFetch" :disabled="!isValidSize || isLoading"
                ...
                <button @click="downloadUsingHref" :disabled="!isValidSize || isLoading"
